...
const PostCard=props=>
{
    ...
    return(
        <div className= "post-card-main-div">
            ...
            <div className="post-card-underline"></div>
            ...
            <div className="post-card-img-div">
                <img className="post-card-img" src="https://scontent.fccu5-1.fna.fbcdn.net/v/t1.6435-0/p526x296/198134406_1954374894749902_4455679327487662630_n.jpg?_nc_cat=105&ccb=1-3&_nc_sid=8bfeb9&_nc_ohc=mhX7Qz8oIVUAX_kOGD1&_nc_ht=scontent.fccu5-1.fna&tp=6&oh=ccac7b29b22281d248a7b5e1f4624ce5&oe=60D08DE0"/>
            </div>
            <div className="post-card-like-count-div">
                <i className="fa-star fas" style={{color:"gold"}}>{"    "+likeCount}</i>
            </div>
            <div className="post-card-underline" style={{width:"90%"}}></div>
            ...
            </div>
            {
                ...
                <h3>Comments</h3>
                <div className="post-card-underline" style={{marginBottom:"10px"}}></div>
                <div className="post-card-random-comment">
                    ...
                    <h4>{randomComment.username}</h4>
                        <p style={{paddingTop: randomComment.commentContent.length<58 && "10px", paddingBottom: randomComment.commentContent.length<58 && "10px" }}>{randomComment.commentContent}</p>
                </div>
            </div>}
        </div>
    );
